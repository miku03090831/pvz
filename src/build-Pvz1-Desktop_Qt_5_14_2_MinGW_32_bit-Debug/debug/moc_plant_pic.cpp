/****************************************************************************
** Meta object code from reading C++ file 'plant_pic.h'
**
...
#include <memory>
#include "../../Pvz1/view/plant_pic.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'plant_pic.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 11), // "framechange"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "framenumber"

    },
    "Plant_Pic\0framechange\0\0framenumber"
};
...
void Plant_Pic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->framechange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
